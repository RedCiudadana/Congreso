...
;define('congreso/controllers/index', ['exports'], function (exports) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    favor: Ember.computed('ley1', 'ley2', 'ley3', function () {
      var perfiles = this.get('model').perfiles;
      var ley1 = this.get('ley1');
      var ley2 = this.get('ley2');
      var ley3 = this.get('ley3');
      return perfiles.filter(function (element) {
    ...
    contra: Ember.computed('ley1', 'ley2', 'ley3', function () {
      var perfiles = this.get('model').perfiles;
      var ley1 = this.get('ley1');
      var ley2 = this.get('ley2');
      var ley3 = this.get('ley3');
    ...
    ausente: Ember.computed('ley1', 'ley2', 'ley3', function () {
      var perfiles = this.get('model').perfiles;
      var ley1 = this.get('ley1');
      var ley2 = this.get('ley2');
      var ley3 = this.get('ley3');
...
;
          if (!runningTests) {
            require("congreso/app")["default"].create({"dataSpreadsheetSourceUrl":"/data-spreadsheet-url","configSpreadsheetSourceUrl":"/config-spreadsheet-url","staticFilesUrl":"https://congreso.redciudadana.org/static-files/","name":"congreso","version":"0.0.0+760cf137"});
          }
