...
;define('congreso/controllers/index', ['exports'], function (exports) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    fire: Ember.computed('onFire', function () {
      console.log('hola');
      undefined._applyFilter();
      return true;
    }),
...
;
          if (!runningTests) {
            require("congreso/app")["default"].create({"dataSpreadsheetSourceUrl":"/data-spreadsheet-url","configSpreadsheetSourceUrl":"/config-spreadsheet-url","staticFilesUrl":"https://congreso.redciudadana.org/static-files/","name":"congreso","version":"0.0.0+064e2918"});
          }
