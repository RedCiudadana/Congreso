...
define('congreso/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('controllers/partidos/partido.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/partidos/partido.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/partidos/partido.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/partidos/partido.js should pass ESLint\n\n2:10 - \'A\' is defined but never used. (no-unused-vars)');
  });
...
define('congreso/tests/lint/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('unit/controllers/partidos/partido-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/partidos/partido-test.js should pass ESLint\n\n');
  });
...
define('congreso/tests/unit/controllers/partidos/partido-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | partidos/partido', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      var controller = this.owner.lookup('controller:partidos/partido');
      assert.ok(controller);
    });
  });
});
...
define('congreso/tests/unit/routes/partidos-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
  ...
  (0, _qunit.module)('Unit | Route | partidos', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var route = this.owner.lookup('route:partidos');
      assert.ok(route);
    });
  });
});
define('congreso/tests/unit/routes/partidos/partido-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
  ...
  (0, _qunit.module)('Unit | Route | partidos/partido', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var route = this.owner.lookup('route:partidos/partido');
      assert.ok(route);
    });
  });
});
